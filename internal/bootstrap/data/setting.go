...
(?U)access_token=(.*)&`,
		...
		{Key: conf.AliTo123, Value: "false", Type: conf.TypeBool, Group: model.SINGLE, Flag: model.PRIVATE},
		{Key: conf.Pan115To123, Value: "false", Type: conf.TypeBool, Group: model.SINGLE, Flag: model.PRIVATE},
		...
		{Key: conf.UssQuarkTv, Value: "false", Type: conf.TypeBool, Group: model.SINGLE, Flag: model.PRIVATE},
		{Key: conf.QuarkMultiAccountProxy, Value: "false", Type: conf.TypeBool, Group: model.SINGLE, Flag: model.PRIVATE},
